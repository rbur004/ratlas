...
static VALUE rb_lapack_xgetrs_mod(VALUE self,  VALUE result, VALUE ipiv, VALUE transpose )
{
  Matrix *m,  *r, *i;
  int error;
  int info;
...
static VALUE rb_lapack_xgetrs( VALUE self, VALUE result, VALUE ipiv, VALUE transpose )
{
  Matrix *dy;
  VALUE  result_copy;
