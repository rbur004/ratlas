...
#ifdef RB_BLAS_C
char *DATA_TYPE_Text[] =   {"", "Double_t", "Single_t", "Integer_t", "Complex_t", "Double_Complex_t" };
#else /*RB_BLAS_C*/
extern  *DATA_TYPE_Text[];
#endif /*RB_BLAS_C*/

enum MATRIX_TYPE {GB=0, GE, HB, HE, HP, SB, SP, SY, TB, TP, TR, US, LU };
#ifdef RB_BLAS_C
char *MATRIX_TYPE_Text[] = {"GB", "GE", "HB", "HE", "HP", "SB", "SP", "SY", "TB", "TP", "TR", "US", "LU" };
#else /*RB_BLAS_C*/
extern  *MATRIX_TYPE_Text[];
#endif /*RB_BLAS_C*/
