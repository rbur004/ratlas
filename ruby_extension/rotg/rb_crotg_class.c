...
static VALUE rblas_crotg_initialize(int argc, VALUE *argv, VALUE obj)
{
  ...
  crotg->r[0] = NUM2DBL(rb_funcall( a,  rb_intern("real"),  0 ) );
  crotg->r[1] = NUM2DBL(rb_funcall( a,  rb_intern("image"),  0 ) );
  crotg->z[0] = NUM2DBL(rb_funcall( b,  rb_intern("real"),  0 ) );
  crotg->z[1] = NUM2DBL(rb_funcall( b,  rb_intern("image"),  0 ) );
...
static VALUE rblas_crotg_set_r(VALUE obj, VALUE r)
{
  ...
  Data_Get_Struct(obj, cRotg, crotg);
  crotg->r[0] = NUM2DBL(rb_funcall( r,  rb_intern("real"),  0 ) );
  crotg->r[1] = NUM2DBL(rb_funcall( r,  rb_intern("image"),  0 ) );
  return r;
}
...
static VALUE rblas_crotg_set_z(VALUE obj, VALUE z)
{
  ...
  Data_Get_Struct(obj, cRotg, crotg);
  crotg->z[0] = NUM2DBL(rb_funcall( z,  rb_intern("real"),  0 ) );
  crotg->z[1] = NUM2DBL(rb_funcall( z,  rb_intern("image"),  0 ) );
  return z;
}
...
static VALUE rblas_crotg_set_s(VALUE obj, VALUE s)
{
  ...
  Data_Get_Struct(obj, cRotg, crotg);
  crotg->s[0] = NUM2DBL(rb_funcall( s,  rb_intern("real"),  0 ) );
  crotg->s[1] = NUM2DBL(rb_funcall( s,  rb_intern("image"),  0 ) );
  return s;
}
